...
因为我是4核虚拟机，采用这种方式线程上下文切换理论上更少。

![image](https://github.com/user-attachments/assets/660fef01-c4a7-4d0f-8685-a7969f61c2a2)


总体来看提升并不高。

(1/8 - 1/9 ) ÷ 1/9 * 100% = 12.5%

异步调用线程结束后，写线程还在执行。此处异步的缺点是缓冲区满时线程会阻塞写，但大部分情况下，线程不需要承担写文件的IO消耗。
